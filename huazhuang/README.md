...
模型: macbert_2290_cosmetics_weibo.pkl, 微博+新的标注+新的处理方法, 没step数测试的结果

step: 1154 **** 
 acc = 0.7881665449233016  #验证集
小红书测试集
总样本数是503,预测错误的样本总数是109
总样本数是503,预测正确的样本总数是394
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.7833001988071571

step: 2308 ****
 acc = 0.7910883856829802  #验证集
小红书测试集
总样本数是503,预测错误的样本总数是49
总样本数是503,预测正确的样本总数是454
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.9025844930417495

step: 3462 ****
 acc = 0.7940102264426588   #验证集
小红书测试集
总样本数是503,预测错误的样本总数是33
总样本数是503,预测正确的样本总数是470
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.9343936381709742

step: 4616 ****
 acc = 0.7947406866325786
总样本数是503,预测错误的样本总数是25
总样本数是503,预测正确的样本总数是478
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.9502982107355865

step: 5770 ****
 acc = 0.7841490138787436
总样本数是503,预测错误的样本总数是15
总样本数是503,预测正确的样本总数是488
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.9701789264413518
