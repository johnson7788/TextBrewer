...
模型: macbert_2290_cosmetics_weibo.pkl, 微博+新的标注+新的处理方法
总样本数是503,预测错误的样本总数是112
总样本数是503,预测正确的样本总数是391
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.7773359840954275


模型: macbert_894_cosmetics.pkl, 新的标注+新的处理方法
总样本数是503,预测错误的样本总数是124
总样本数是503,预测正确的样本总数是379
保存全部为错误的样本到excel: wrong.xlsx完成
保存全部为正确的样本到excel: correct.xlsx完成
准确率为0.7534791252485089
