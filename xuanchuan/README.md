...
# 评估教师模型
python main.distill.py  --vocab_file bert_model/vocab.txt --data_dir data_root_dir/caiye --bert_config_file_T bert_model/config.json --bert_config_file_S bert_model/config.json  --tuned_checkpoint_T trained_teacher_model/gs3024.pkl --load_model_type all --tuned_checkpoint_S trained_teacher_model/gs3024.pkl  --do_predict --max_seq_length 30  --random_seed 9580 --output_dir output_root_dir/caiye_eval  --temperature 8 --task_name caiye
